...
class SurgeryController extends Controller
{
    protected $web3;
    protected $contract;
    protected $contractAddress = '0x01897CfA22B3533447Af3d13e0e0a045dcEb0902'; // Replace with actual contract address
    ...
    public function addSurgery(Request $request) {
        ...
        try {
            $this->sendTransaction('addSurgery', [$nationalId, $imageUrl, $date]);
    ...
    public function getSurgery($nationalId)
    {
        try {
            Log::info('Request received for nationalId: ' . $nationalId);

            $this->contract->at($this->contractAddress)->call('getSurgery', $nationalId, ['from' => $this->fromAddress], function ($err, $result) use ($nationalId) {
                if ($err !== null) {
