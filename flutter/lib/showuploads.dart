...
class ShowUploadsPage extends StatefulWidget {
  final Patient user;

  ShowUploadsPage({required this.user});

  @override
  State<ShowUploadsPage> createState() => _ShowUploadsPageState();
}

class _ShowUploadsPageState extends State<ShowUploadsPage> {
  @override
